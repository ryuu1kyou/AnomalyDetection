...
public class AnomalyDetectionDbContext :
    AbpDbContext<AnomalyDetectionDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public DbSet<OemMaster> OemMasters { get; set; }
    public DbSet<ExtendedTenant> ExtendedTenants { get; set; }

    // CAN Signal Management
    public DbSet<CanSignal> CanSignals { get; set; }
    public DbSet<CanSystemCategory> CanSystemCategories { get; set; }

    // Anomaly Detection
    public DbSet<CanAnomalyDetectionLogic> CanAnomalyDetectionLogics { get; set; }
    public DbSet<AnomalyDetectionResult> AnomalyDetectionResults { get; set; }
    public DbSet<DetectionParameter> DetectionParameters { get; set; }
    public DbSet<CanSignalMapping> CanSignalMappings { get; set; }

    // Project Management
    public DbSet<AnomalyDetectionProject> AnomalyDetectionProjects { get; set; }
