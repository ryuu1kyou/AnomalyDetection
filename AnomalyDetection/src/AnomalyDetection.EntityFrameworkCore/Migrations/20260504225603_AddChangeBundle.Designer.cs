...
namespace AnomalyDetection.Migrations
{
    ...
    [Migration("20260504225603_AddChangeBundle")]
    partial class AddChangeBundle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnomalyDetection.AnomalyDetection.CanAnomalyDetectionLogic", b =>
                {
                    ...
                    b.Property<int>("CommonalityStatus")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.Property<string>("DesignRationale")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");

                    b.Property<int>("DocSyncStatus")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.Property<string>("PurposeShort")
                        .HasMaxLength(200)
                    ...
                    b.Property<DateTime?>("UnknownResolutionDueDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("CommonalityStatus");

                    b.HasIndex("DecisionId");

                    b.HasIndex("DocSyncStatus");
            ...
            modelBuilder.Entity("AnomalyDetection.ChangeTracking.ChangeBundle", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppChangeBundles", (string)null);
                });

            modelBuilder.Entity("AnomalyDetection.ChangeTracking.ChangeBundleItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ChangeBundleId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ChangeBundleId");

                    b.HasIndex("EntityId", "EntityType");

                    b.ToTable("AppChangeBundleItems", (string)null);
                });
            ...
            modelBuilder.Entity("AnomalyDetection.ChangeTracking.ChangeBundleItem", b =>
                {
                    b.HasOne("AnomalyDetection.ChangeTracking.ChangeBundle", null)
                        .WithMany("Items")
                        .HasForeignKey("ChangeBundleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
