...
public class AnomalyDetectionDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        AnomalyDetectionGlobalFeatureConfigurator.Configure();
        AnomalyDetectionModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<AnomalyDetectionDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<AnomalyDetectionResource>("ar")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/AnomalyDetection");

            options.DefaultResourceType = typeof(AnomalyDetectionResource);
        ...
        {
            options.MapCodeNamespace("AnomalyDetection", typeof(AnomalyDetectionResource));
        });
    }
}
