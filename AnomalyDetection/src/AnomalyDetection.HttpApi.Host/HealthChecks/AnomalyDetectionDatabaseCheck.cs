...
public class AnomalyDetectionDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public AnomalyDetectionDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
